...
from proto import quantum_switch_pb2
from proto import quantum_switch_pb2_grpc

logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')

class QuantumSwitchServicer(quantum_switch_pb2_grpc.QuantumSwitchServiceServicer):
    ...
    def SetCrossConnect(self, request, context):
        ...
        return quantum_switch_pb2.CrossConnectResponse(
            success=success,
            message=msg
        )
    ...
    def GetCrossConnectStatus(self, request, context):
        ...
        return quantum_switch_pb2.StatusResponse(
...
def serve():
    ...
    quantum_switch_pb2_grpc.add_QuantumSwitchServiceServicer_to_server(
        QuantumSwitchServicer(driver), server
    )
